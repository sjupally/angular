...
/* harmony import */ var _shared_util_services_masters_api__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../shared/util/services/masters.api */ "./src/app/shared/util/services/masters.api.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(modalService, router, vehicleApiService, dashBoardApiService, toasterService, mastersServicesApi, calendar) {
        this.modalService = modalService;
        this.router = router;
        this.vehicleApiService = vehicleApiService;
        this.dashBoardApiService = dashBoardApiService;
        this.toasterService = toasterService;
        this.mastersServicesApi = mastersServicesApi;
    ...
    DashboardComponent.prototype.getDistricts = function (value) {
        var _this = this;
        if (value === '') {
            this.districtArray = [];
        }
        this.districtModel = '';
        this.mastersServicesApi.getDistricts(value).subscribe(function (data) {
            _this.districtArray = data;
        });
    };
    DashboardComponent.prototype.getCities = function (value) {
        var _this = this;
        this.cityModel = '';
        if (value === '') {
            this.cityArray = [];
        }
        this.mastersServicesApi.getCities(value).subscribe(function (data) {
    ...
    DashboardComponent.prototype.todayinstallednavigate = function () {
        this.router.navigate(['/rta/vehicles', { 'isTodaysInstalled': true }]);
    };
    DashboardComponent.prototype.pendingNavigate = function () {
        this.router.navigate(['/rta/vehicles', { 'pendinginstallation': false }]);
    };
    DashboardComponent.prototype.allInstalled = function () {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbModal"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _shared_vehicles_services_vehicle_api_service__WEBPACK_IMPORTED_MODULE_4__["VehicleApiService"],
            _services_dashboard_api_service__WEBPACK_IMPORTED_MODULE_5__["DashBoardApiService"], _shared_util_toaster_service__WEBPACK_IMPORTED_MODULE_9__["ToasterService"], _shared_util_services_masters_api__WEBPACK_IMPORTED_MODULE_10__["MastersServicesApi"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbCalendar"]])
    ], DashboardComponent);
...
var DevicemappingComponent = /** @class */ (function () {
    ...
    DevicemappingComponent.prototype.downloadpdf = function () {
        var _this = this;
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_4___default()(data).then(function (canvas) {
            ...
            pdf.save(_this.iotMappingModel.rcNumber + '.pdf');
        });
    };
...
module.exports = ".dropdown-toggle:after{\r\n    display: none;;\r\n}\r\n.main-navbar{\r\n    position: relative;\r\n    margin: 0;\r\n    padding: 15px 0px 0px 0px;\r\n    list-style: none;\r\n    height: 34px;\r\n}\r\n.dropdown-menu{\r\n    top:56px;\r\n    margin-top:0px!important;\r\n    background-color:#6742c0;\r\n    width:230px;\r\n}\r\n.dropdown-menu li a{\r\n    display: block;\r\n    padding:12px 16px 12px 16px;\r\n    color:#ffffff47;\r\n}\r\n.dropdown-menu li a:hover{\r\n    color:#ffffff;\r\n    text-decoration: none;\r\n}\r\n.dropdown-menu li a img{\r\n    height:20px;\r\n    padding-right:10px;\r\n}\r\n.dropdown-submenu {\r\n    position: relative;\r\n    margin-top:0px;\r\n}\r\n.dropdown-submenu>.dropdown-menu {\r\n    top: 0;\r\n    left: 100%;\r\n    margin-top: -6px;\r\n    margin-left: 0px;\r\n    border-radius: 0 6px 6px 6px;\r\n    background-color:#6742c0;\r\n    position: absolute;\r\n    border-left:1px solid #ffffff!important;\r\n}\r\n.dropdown-submenu:hover>.dropdown-menu {\r\n    display: block;\r\n}\r\n.dropdown-submenu>a:after {\r\n    display: block;\r\n    content: \" \";\r\n    float: right;\r\n    width: 0;\r\n    height: 0;\r\n    border-color: transparent;\r\n    border-style: solid;\r\n    border-width: 5px 0 5px 5px;\r\n    border-left-color: #ccc;\r\n    margin-top: 5px;\r\n    margin-right: -5px;\r\n}\r\n.dropdown-submenu:hover>a:after {\r\n    border-left-color: none;\r\n}\r\n.dropdown-submenu.pull-left {\r\n    float: none;\r\n}\r\n.dropdown-submenu.pull-left>.dropdown-menu {\r\n    left: -100%;\r\n    margin-left: 10px;\r\n    border-radius: 6px 0 6px 6px;\r\n}\r\n.profilemenu{\r\n    color:#ffffff;\r\n}\r\n.profilemenu img.avatar{\r\n    width:40px;\r\n    height:40px;\r\n    border-radius:100px;\r\n}\r\n.profilename{\r\n    padding-left:5px;\r\n    padding-top:4px;\r\n}\r\n.caret {\r\n    display: inline-block;\r\n    width: 0;\r\n    height: 0;\r\n    margin-left: 2px;\r\n    vertical-align: middle;\r\n    border-top: 6px dashed;\r\n    border-top: 6px solid #ffffff;\r\n    border-right: 6px solid transparent;\r\n    border-left: 6px solid transparent;\r\n}\r\n.navbar-fixed{\r\n    position:fixed;\r\n    top:0px;\r\n    left:0px;\r\n    width:100%;\r\n    z-index:999;\r\n}\r\n.profile.dropdown-menu{\r\n    width:177px !important;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _message_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./message.model */ "./src/app/rta/main/message.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.connect = function () {
        ...
        this.stompClient.connect({}, function (frame) {
            ...
            _this.stompClient.subscribe('/topic/messages', function (hello) {
                var message = new _message_model__WEBPACK_IMPORTED_MODULE_5__["Message"]();
    ...
    MainComponent.prototype.openPanicAlerts = function (isMobile) {
        this.msgs = [];
        if (isMobile) {
...
/***/ "./src/app/rta/main/message.model.ts":
/*!*******************************************!*\
  !*** ./src/app/rta/main/message.model.ts ***!
  \*******************************************/
...
/* harmony import */ var _shared_util_services_masters_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/util/services/masters.api */ "./src/app/shared/util/services/masters.api.ts");
...
var OperationalReportsComponent = /** @class */ (function () {
    function OperationalReportsComponent(vehicleApiService, calendar, mastersServicesApi) {
        this.vehicleApiService = vehicleApiService;
        this.calendar = calendar;
        this.mastersServicesApi = mastersServicesApi;
        this.districtArray = [];
        ...
        this.previousLiveVehicleArray = [];
        this.isFirstLoad = true;
        this.gMaps = _agm_core__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsAPIWrapper"];
        this.userDetails = JSON.parse(localStorage.getItem('userdetails'));
        this.districtModel = '';
        this.cityModel = '';
        this.model = this.calendar.getToday();
    ...
    OperationalReportsComponent.prototype.ngOnInit = function () {
        ...
        this.getVehicle = setInterval(function () {
            _this.getLiveVehicles();
        }, 10000);
    };
    OperationalReportsComponent.prototype.getDistricts = function (value) {
        var _this = this;
        if (value === '') {
            this.districtArray = [];
        }
    ...
    OperationalReportsComponent.prototype.getCities = function (value) {
        var _this = this;
        this.cityModel = '';
        if (value === '') {
            this.cityArray = [];
    ...
    OperationalReportsComponent.prototype.mapReady = function (map) {
        this.map = map;
    ...
    OperationalReportsComponent.prototype.clickedMarker = function (label, index, $event) {
    ...
    OperationalReportsComponent.prototype.prepareDatatoDispaly = function () {
        for (var current = 0; current < this.liveVehicleArray.length; current++) {
            for (var previous = 0; previous < this.previousLiveVehicleArray.length; previous++) {
                var preLiveVehicle = this.previousLiveVehicleArray[previous];
                var curLiveVehicle = this.previousLiveVehicleArray[current];
                if (preLiveVehicle.rcNumber === curLiveVehicle.rcNumber) {
                    var oldposition = new google.maps.LatLng(preLiveVehicle.latitude, preLiveVehicle.langitude);
    ...
    OperationalReportsComponent.prototype.calcuateDegree = function (oldLatitude, oldLangitude, curLatitude, curLangitude) {
        var pi = Math.PI;
        var lat1 = oldLatitude * pi / 180;
        var long1 = oldLangitude * pi / 180;
        var lat2 = curLatitude * pi / 180;
        var long2 = curLangitude * pi / 180;
    ...
    OperationalReportsComponent.prototype.ngOnDestroy = function () {
        if (this.getVehicle) {
    ...
    OperationalReportsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_vehicles_services_vehicle_api_service__WEBPACK_IMPORTED_MODULE_1__["VehicleApiService"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbCalendar"], _shared_util_services_masters_api__WEBPACK_IMPORTED_MODULE_3__["MastersServicesApi"]])
...
/* harmony import */ var _shared_usermanagement_usermanagement_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../shared/usermanagement/usermanagement.component */ "./src/app/shared/usermanagement/usermanagement.component.ts");
/* harmony import */ var _shared_rawdata_rawdata_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../shared/rawdata/rawdata.component */ "./src/app/shared/rawdata/rawdata.component.ts");
/* harmony import */ var _shared_modemdetails_modemdetails_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../shared/modemdetails/modemdetails.component */ "./src/app/shared/modemdetails/modemdetails.component.ts");
/* harmony import */ var _shared_show_video_show_video_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../shared/show-video/show-video.component */ "./src/app/shared/show-video/show-video.component.ts");
/* harmony import */ var _shared_livetracking_livetracking_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../shared/livetracking/livetracking.component */ "./src/app/shared/livetracking/livetracking.component.ts");
/* harmony import */ var _shared_administrative_list_administrative_list_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../shared/administrative-list/administrative-list.component */ "./src/app/shared/administrative-list/administrative-list.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var rtaRoutes = [
    { path: '', component: _main_main_component__WEBPACK_IMPORTED_MODULE_2__["MainComponent"],
        children: [
            ...
            { path: 'usermanagement', component: _shared_usermanagement_usermanagement_component__WEBPACK_IMPORTED_MODULE_18__["UsermanagementComponent"] },
            { path: 'rawdata', component: _shared_rawdata_rawdata_component__WEBPACK_IMPORTED_MODULE_19__["RawdataComponent"] },
            { path: 'modemdetails', component: _shared_modemdetails_modemdetails_component__WEBPACK_IMPORTED_MODULE_20__["ModemdetailsComponent"] },
            { path: 'showvideo', component: _shared_show_video_show_video_component__WEBPACK_IMPORTED_MODULE_21__["ShowVideoComponent"] },
            { path: 'showvideos', component: _shared_show_video_show_video_component__WEBPACK_IMPORTED_MODULE_21__["ShowVideoComponent"] },
            { path: 'livetracking', component: _shared_livetracking_livetracking_component__WEBPACK_IMPORTED_MODULE_22__["LivetrackingComponent"] },
            { path: 'administrativelist', component: _shared_administrative_list_administrative_list_component__WEBPACK_IMPORTED_MODULE_23__["AdministrativeListComponent"] }
        ]
    }
];
...
/* harmony import */ var _rta_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./rta-routing.module */ "./src/app/rta/rta-routing.module.ts");
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _main_main_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./main/main.component */ "./src/app/rta/main/main.component.ts");
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./header/header.component */ "./src/app/rta/header/header.component.ts");
/* harmony import */ var _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/rta/dashboard/dashboard.component.ts");
/* harmony import */ var _newregistration_newregistration_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./newregistration/newregistration.component */ "./src/app/rta/newregistration/newregistration.component.ts");
/* harmony import */ var _devicemapping_devicemapping_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./devicemapping/devicemapping.component */ "./src/app/rta/devicemapping/devicemapping.component.ts");
/* harmony import */ var _operational_reports_operational_reports_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./operational-reports/operational-reports.component */ "./src/app/rta/operational-reports/operational-reports.component.ts");
/* harmony import */ var _reports_reports_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./reports/reports.component */ "./src/app/rta/reports/reports.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    RtaModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _rta_routing_module__WEBPACK_IMPORTED_MODULE_8__["RtaRoutingModule"],
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_9__["SharedModule"],
                _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModule"]
            ],
            declarations: [_main_main_component__WEBPACK_IMPORTED_MODULE_10__["MainComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_11__["HeaderComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_12__["DashboardComponent"], _newregistration_newregistration_component__WEBPACK_IMPORTED_MODULE_13__["NewregistrationComponent"], _devicemapping_devicemapping_component__WEBPACK_IMPORTED_MODULE_14__["DevicemappingComponent"],
                _operational_reports_operational_reports_component__WEBPACK_IMPORTED_MODULE_15__["OperationalReportsComponent"],
                _reports_reports_component__WEBPACK_IMPORTED_MODULE_16__["ReportsComponent"]],
            entryComponents: [_newregistration_newregistration_component__WEBPACK_IMPORTED_MODULE_13__["NewregistrationComponent"]]
        })
    ], RtaModule);
    return RtaModule;
}());
